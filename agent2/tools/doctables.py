...
TABLES = (
    ...
    DocTable("equity_method", "관계기업·공동기업 투자",
             ("관계기업", "공동기업", "지분법"), ("지분법",),
             # `지분법손익` 완전일치는 표기 변형을 놓친다(전수 70사: 6사).
             # `지분법평가손익`·`지분법평가`. 섹션이 관계기업/공동기업이라 밖으로 안 번진다.
             ("연결", "기초", "취득", "당기말", "기말"),
             ("합 계", "합계", "계", "총계"),
    ...
    DocTable("ppe_movement", "유형자산 증감",
             ("유형자산",), ("처분",),
             # `손상차손`을 함께 요구하면 그 해 손상이 없는 회사를 통째로 놓친다
             # (전수 70사: 31사). `impairment`(누계액표)와 가르는 셀은 `처분`이다.
             ("연결", "기초", "취득", "감가상각", "기말"),
             ("합 계", "합계", "계", "유형자산 합계"),
    ...
    DocTable("orders", "수주 상황",
             ...
             ("수주잔",),
             # `수주잔고`·`수주잔액`·`수주잔` 어간. 완전일치는 2사를 놓쳤다.
